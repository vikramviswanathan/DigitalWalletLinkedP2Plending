...
import com.rpqb.hackathon.p2plending.constants.Constants;
...
public class Signup_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerUserAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, Constants.userTypeList);
        spinnerKYCAdpater = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, Constants.kycDocumentsList);
    ...
    public boolean validate() {
        ...
        if (!android.util.Patterns.PHONE.matcher(phoneNumber).matches()) {
            edtTxtPhoneNo.setError(getResources().getString(R.string.signup_phoneNoError));
            valid = false;
        } else {
            edtTxtPhoneNo.setError(null);
        }
