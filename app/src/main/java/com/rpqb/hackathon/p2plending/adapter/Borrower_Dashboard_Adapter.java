...
public class Borrower_Dashboard_Adapter extends RecyclerView.Adapter<Borrower_Dashboard_Adapter.ViewHolder> {
    private final String TAG = this.getClass().getSimpleName();
    private Context mContext;
    private OnItemClickListener mItemClickListener;
    private ArrayList<Project> projectList;

    public Borrower_Dashboard_Adapter(Context mContext, ArrayList<Project> projectList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            linearMainHolder = (LinearLayout) itemView.findViewById(R.id.borrower_dashboard_linearMainHolder);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.borrower_dashboard_grid_item, parent, false);
